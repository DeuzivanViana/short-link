...
export const LinkCard = (props : Props) => {
  ...
  return <div className='p-6 bg-neutral-800 text-neutral-50 flex flex-col gap-4 rounded-xl'>
    <div className='flex gap-2 items-center'>
      ...
      <h1 className='whitespace-nowrap overflow-hidden text-ellipsis max-w-[80%] text-sm'>http://192.168.1.107:3000/l/{ props.id }</h1>
    </div>
    <footer className='whitespace-nowrap overflow-hidden text-ellipsis max-w-[80%] text-xs'>{ props.redirect }</footer>
